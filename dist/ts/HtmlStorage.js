export class HtmlStorage {
    ...
    static getHappySMileyImg() {
        return (`<img class="restart-img" src="https://res.cloudinary.com/dpnevk8db/image/upload/v1709832876/icons8-cool-48_urbgkm.png">`);
    }
    static getLightBulbSvg(idx = '') {
