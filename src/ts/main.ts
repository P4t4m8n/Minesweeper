...
function onContextClick(ev: Event, game: Game) {
    ...
    if (isMarked)
        ...
        if (markedCount >= game.getMines()) return alert('Max flags')
        game.setMarkedCount(markedCount + 1)
...
function _getNumberHtml(number: number): string {
    let color: string
...
function _getSmileySvg(): string {
    return (
        `<svg class="restart-svg" viewBox="-2 -2 24 24" preserveAspectRatio="xMinYMin" class="jam jam-smiley">
...
function _getWorriedSmiley(): string {
    return (
        `<svg class="restart-svg" viewBox="0 0 256 256" >
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
...
function _getHappySMiley(): string {
    return (
        `<svg viewBox="0 0 106.058 106.059" xml:space="preserve">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
